...
namespace BL
{
    ...
    public class ApplicationUserManager : UserManager<Usuario>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Usuario>(context.Get<DbContext>()));
            ...
            manager.RegisterTwoFactorProvider("Código telefónico", new PhoneNumberTokenProvider<Usuario>
            {
                MessageFormat = "Su código de seguridad es {0}"
            });
            manager.RegisterTwoFactorProvider("Código de correo electrónico", new EmailTokenProvider<Usuario>
            {
