...
namespace PL
{
    ...
    public static class Settings
    {
        ...
        public static readonly string CurrentThemeLogin = GetValue<string>("CurrentThemeLogin");

        public static readonly string CurrentThemeDefault = GetValue<string>("CurrentThemeDefault");
    }
}