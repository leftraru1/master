    ...
    (function () {
        ...
        */
        function renderParsedFormat(parsedFormat, date1, date2, separator, isRTL) {
            ...
            if (renderedParts1.length <= 1) {
                var data = renderedParts1[0];
                renderedParts1 = data.split(' ');
                if (renderedParts1.length <= 1) {
                    data = renderedParts1[0];
                    renderedParts1 = data.split(':');
                    for (i = 0; i <= renderedParts1.length - 1; i++) {
                        renderedParts1[i] = renderedParts1[i] + ' ';
                    }
                }
                else {
                    for (i = 0; i <= renderedParts1.length - 1; i++) {
            ...
            if (renderedParts2.length <= 1) {
                var data = renderedParts2[0];
                renderedParts2 = data.split(' ');
                if (renderedParts2.length <= 1) {
                    data = renderedParts2[0];
                    renderedParts2 = data.split(':');
                    for (i = 0; i <= renderedParts2.length - 1; i++) {
                        renderedParts2[i] = renderedParts2[i] + ' ';
                    }
                }
                else {
                    for (i = 0; i <= renderedParts2.length - 1; i++) {
            ...
            for (
                ...
                //if (renderedParts1.length > leftI)
                if (renderedParts1[leftI] !== undefined)
            ...
            for (
                ...
                if (renderedParts1[rightI] !== undefined)
